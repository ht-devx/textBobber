/*----------------------------------------------------
      ...
      * v3.0.0 [2025-02-12], updt. 2025-03-15
    ...
    wrapperSel?.forEach(wrapper => {
      ...
      if(wrapper && textContainer && allTextsWrap){
        ...
        if(selectors){
          ...
          })//end [text-bobber] each || end do stuff with each text

          /*------ MAIN FUNCTIONALITY DOWN HERE ------*/
          setTimeout(() => {
            ...
            if(bub1 && noDataCurrents){
              ...
              setTimeout(() => {
                ...
                bub1.style.display = "block"
                requestAnimationFrame(() => {
                  requestAnimationFrame(() => {
                    bub1.classList.add("show")
                  })
                })
